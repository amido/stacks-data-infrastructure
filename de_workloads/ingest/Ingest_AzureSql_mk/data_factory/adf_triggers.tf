resource "azurerm_data_factory_trigger_tumbling_window" "trigger_Ingest_AzureSql_mk" {
  name            = "trigger_Ingest_AzureSql_mk"
  ...
  depends_on = [
    azurerm_resource_group_template_deployment.pipeline_Ingest_AzureSql_mk
  ]
}
