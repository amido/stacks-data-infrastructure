resource "azurerm_resource_group_template_deployment" "pipeline_ingest_azure_sql_andytest" {
  name                = "pipeline_ingest_azure_sql_andytest"
  ...
  depends_on = [
    azurerm_data_factory_custom_dataset.ds_azure_sql_andytest
  ]
}
