resource "azurerm_resource_group_template_deployment" "pipeline_Ingest_AzureSql_GC" {
  name                = "pipeline_Ingest_AzureSql_GC"
  ...
  depends_on = [
    azurerm_data_factory_custom_dataset.ds_AzureSql_GC
  ]
}
