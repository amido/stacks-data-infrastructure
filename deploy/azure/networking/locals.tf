locals {
  ...
  network_details = {
    "hub_network" = {
      ...
      subnet_details = {
        "subnet-1" = {
          sub_name                                      = "${var.name_company}-${lookup(local.location_name_map, var.resource_group_location)}-hub"
        ...
        "subnet-3" = {
          ...
          sub_address_prefix                            = ["10.1.0.0/26"]
          private_endpoint_network_policies_enabled     = true
          private_link_service_network_policies_enabled = true
          service_endpoints = ["Microsoft.AzureActiveDirectory",
            "Microsoft.KeyVault",
    ...
    "nonprod-network" = {
      ...
      subnet_details = {
        "subnet-1" = {
          sub_name                                      = "${var.name_company}-${lookup(local.location_name_map, var.resource_group_location)}-nonprod-pe"
        ...
        "subnet-2" = {
          sub_name                                      = "${var.name_company}-${lookup(local.location_name_map, var.resource_group_location)}-nonprod"
    ...
    "prod-network" = {
      ...
      subnet_details = {
        "subnet-1" = {
          sub_name                                      = "${var.name_company}-${lookup(local.location_name_map, var.resource_group_location)}-prod-pe"
        ...
        "subnet-2" = {
          sub_name                                      = "${var.name_company}-${lookup(local.location_name_map, var.resource_group_location)}-prod"
