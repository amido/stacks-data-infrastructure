...
variable "network_details" {
  ...
  default = {
    ...
    "radu-stacks-euw-de-qa-nonprod" = {
      name                = "radu-stacks-euw-de-qa-nonprod"
      address_space       = ["10.8.0.0/16"]
      dns_servers         = []
      resource_group_name = "radu-stacks-euw-de-qa-nonprod-network"
      is_hub              = false
      link_to_private_dns = true
      subnet_details = {
        "radu-stacks-euw-de-qa-nonprod-pe" = {
          sub_name                                      = "radu-stacks-euw-de-qa-nonprod-pe"
          sub_address_prefix                            = ["10.8.1.0/24"]
          private_endpoint_network_policies_enabled     = true
          private_link_service_network_policies_enabled = true
          service_endpoints                             = ["Microsoft.AzureActiveDirectory", "Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage"]
        },
        "radu-stacks-euw-de-qa-nonprod" = {
          sub_name                                      = "radu-stacks-euw-de-qa-nonprod"
          sub_address_prefix                            = ["10.8.2.0/24"]
          private_endpoint_network_policies_enabled     = true
          private_link_service_network_policies_enabled = true
          service_endpoints                             = ["Microsoft.AzureActiveDirectory", "Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage"]
        }
    ...
    "radu-stacks-euw-de-qa-prod" = {
      name                = "radu-stacks-euw-de-qa-prod"
      address_space       = ["10.9.0.0/16"]
      dns_servers         = []
      resource_group_name = "radu-stacks-euw-de-qa-prod-network"
      is_hub              = false
      link_to_private_dns = true
      subnet_details = {
        "radu-stacks-euw-de-qa-prod-pe" = {
          sub_name                                      = "radu-stacks-euw-de-qa-prod-pe"
          sub_address_prefix                            = ["10.9.1.0/24"]
          private_endpoint_network_policies_enabled     = true
          private_link_service_network_policies_enabled = true
          service_endpoints                             = ["Microsoft.AzureActiveDirectory", "Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage"]
        },
        "radu-stacks-euw-de-qa-prod" = {
          sub_name                                      = "radu-stacks-euw-de-qa-prod"
          sub_address_prefix                            = ["10.9.2.0/24"]
          private_endpoint_network_policies_enabled     = true
          private_link_service_network_policies_enabled = true
          service_endpoints                             = ["Microsoft.AzureActiveDirectory", "Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage"]
        }
